...
module.exports = buildModule("InsurancePayOutModule", (m) => {
    ...
    const InsurancePayOut = m.contract("InsurancePayOut", [insurancePolicyAddress, escrowAddress, insuranceClaimsAddress]);
